        ...
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="username" class="form-control"
                            placeholder="@lang('employees.username')" required
                            value="{{ isset($row) ? old('username') ?? $row->username : old('username') }}"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="@lang('employees.email')"
                            required value="{{ isset($row) ? old('email') ?? $row->email : old('email') }}">
                    </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="@lang('employees.phone')"
                            required value="{{ isset($row) ? old('phone') ?? $row->phone : old('phone') }}"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="address" class="form-control" placeholder="@lang('employees.address')"
                            required value="{{ isset($row) ? old('address') ?? $row->address : old('address') }}"
                            minlength="10" maxlength="100">
                    </div>
                    <span class="error red" id="address_error"></span>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" name="password" class="form-control"
                            placeholder="@lang('employees.password')" autocomplete min="3" max="50"
                            {{ isset($row) ? '' : 'required' }}>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <span class="error red" id="personal_id_error"></span>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control"
                            value="{{ isset($row) ? old('emp_id') ?? $row->emp_id : old('emp_id') }}" disabled>
                    </div>
                    <span class="error red" id="emp_id_error"></span>
                </div>
            </div>
            @endif
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="date" name="birthday" class="form-control" max="2015-12-12" min="1990-01-01"
                            required placeholder="@lang('employees.birthday')"
                            value="{{ isset($row) ? old('birthday') ?? $row->birthday : old('birthday') }}">
                    </div>
                    <span class="error red" id="birthday_error"></span>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select name='role' class="custom-select" id="roles" required>
                            ...
                            <optgroup label="@lang('employees.job')">
                                ...
                                <option value="{{ $role->name }}" @if (isset($row))
                                    {{ $row->hasRole($role->name) ? 'selected' : (old('role') == $role->name ? 'selected' : '') }}
                                    @else {{ old('role') == $role->name ? 'selected' : '' }} @endif>
                                    {{ $role->display_name }}
                                </option>
                                @endif
                                @endforeach
                    ...
                    <span class="error red" id="role_error"></span>
                </div>
            </div>
        </div>
